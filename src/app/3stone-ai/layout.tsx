    ...
    <div className="flex min-h-screen flex-col bg-bg">
      <header className="flex h-14 flex-shrink-0 items-center justify-between border-b border-line bg-surface px-6">
        ...
        <nav className="flex items-center gap-4 text-[13px] font-medium text-ink-2">
          ...
          <Link href="/3stone-ai/picks" className="hover:text-ink-1">
            3Stone Picks
          </Link>
          <Link href="/3stone-ai/counsel" className="hover:text-ink-1">
            3Stone Counsel
          </Link>
          <Link href="/3stone-ai/prospects" className="hover:text-ink-1">
            Sales Pipeline
          </Link>
          <Link href="/3stone-ai/integrations" className="hover:text-ink-1">
            Integrations
          </Link>
          <Link href="/3stone-ai/support" className="hover:text-ink-1">
            Problem Reports
          </Link>
          <Link href="/3stone-ai/feature-flags" className="hover:text-ink-1">
            Feature Flags
          </Link>
          <Link href="/3stone-ai/announcements" className="hover:text-ink-1">
            Announcements
          </Link>
          <Link href="/3stone-ai/demo-profiles" className="hover:text-ink-1">
            Demo Profiles
          </Link>
          <Link href="/3stone-ai/staff" className="hover:text-ink-1">
            Staff
          </Link>
          <Link href="/3stone-ai/audit-log" className="hover:text-ink-1">
            Audit Log
          </Link>
          <Link href="/3stone-ai/system-health" className="hover:text-ink-1">
            System Health
          </Link>
